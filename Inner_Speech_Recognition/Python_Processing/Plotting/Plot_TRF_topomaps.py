...
save_dir='/media/nnieto/50e793fa-4717-4997-b590-b4167be63ee7/home/nnieto/Escritorio/Nico/Doctorado/Tesis/LIAA - sinc(i)/Toma de datos/Analisis/Espectrales/Dataset final/TopoPSD_sigle/PSD_Topomaps/'
...
power = Extract_TFR(TRF_dir = root_spectrograms, Cond = Condition, Class = Class, TFR_method = TRF_method, TRF_type = TRF_type)
...
for band in range (len(bands)):
    ...
    power.plot_topomap(fmin=bands_loop[0], fmax=bands_loop[1], tmin=tmin, tmax=tmax,
    ...
    if save_bool:
        ...
        if baseline_bool:
            fig.savefig(save_dir + prefix+'_'+Condition+'_'+Class+'_band'+str(band)+'_Baseline.png',
                        transparent = True)  

        else :
            fig.savefig(save_dir + prefix+'_'+Condition + '_'+Class + '_band'+str(band)+'_NO_Baseline.png',
                        transparent = True)  
